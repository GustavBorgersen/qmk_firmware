...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(	KC_ESC, KC_Q,   KC_W,   KC_E,       KC_R,   KC_T, 			KC_Y,       KC_U,   KC_I,   KC_O,   KC_P,       KC_LBRC,
								...
								KC_LSFT,KC_Z,   KC_X,   KC_C,       KC_V,   KC_B,			KC_N,       KC_M,   KC_COMM,KC_DOT, KC_SLSH,    KC_ENT,
												        KC_LALT,    MO(1),  KC_SPC, 	    KC_BSPC,    MO(2),  KC_LGUI),

	[1] = LAYOUT_split_3x6_3(	KC_UNDS, 	KC_EXLM, 	KC_AT, 		KC_HASH,    KC_PERC,    KC_CIRC, 			    KC_AMPR, KC_PAST,   RALT(KC_MINS),  KC_ASTR,        KC_LPRN,    KC_RPRN,
								RALT(KC_2), KC_TRNS, 	KC_TRNS, 	RALT(KC_3), RALT(KC_4), KC_NO, 	                KC_NUBS, KC_UP,     LSFT(KC_NUBS),  RALT(KC_7),     RALT(KC_0), RALT(KC_NUBS),
								KC_LCTL,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_NO, 			        KC_LEFT, KC_DOWN,   KC_RGHT,        RALT(KC_8),     RALT(KC_9), KC_ENT,
	...
	[2] = LAYOUT_split_3x6_3(   KC_NO,      KC_NO,  KC_NO,  KC_NO,      KC_NO,  KC_NO,              KC_PSLS,    KC_PAST,    KC_P7,  KC_P8,  KC_P9,  KC_PMNS,
                                KC_TAB,     KC_NO,  KC_NO,  KC_NO,      KC_NO,  KC_NO,              KC_NO,      KC_NO,      KC_P4,  KC_P5,  KC_P6,  KC_PPLS,
